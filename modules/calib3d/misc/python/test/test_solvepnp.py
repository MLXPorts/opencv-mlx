...
class solvepnp_test(NewOpenCVTests):
    ...
    def test_regression_16040(self):
        obj_points = mx.array([[0, 0, 0], [0, 1, 0], [1, 1, 0], [1, 0, 0]], dtype=mx.float32)
        img_points = mx.array(
            [[700, 400], [700, 600], [900, 600], [900, 400]], dtype=mx.float32
        )

        cameraMatrix = mx.array(
            [[712.0634, 0, 800], [0, 712.540, 500], [0, 0, 1]], dtype=mx.float32
        )
        distCoeffs = mx.array([[0, 0, 0, 0]], dtype=mx.float32)
        r = mx.array([], dtype=mx.float32)
